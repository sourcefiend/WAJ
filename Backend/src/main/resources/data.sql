...
INSERT into review (title, text, rating_id, hardware_id) VALUES ('review1', 'ovo je review 1', 'ONE', 1);
INSERT into review (title, text, rating_id, hardware_id) VALUES ('review2', 'ovo je review 2', 'FOUR', 1);
...
INSERT INTO user (id, username, password) VALUES (1, 'user', '$2a$12$qIfhnfF8PHVNHsHpgaE1y.dfklY/cp4fbsic.J3/zq5U4zfDPeE0C'); -- password = user
INSERT INTO user (id, username, password) VALUES (2, 'admin', '$2a$12$OR9SeNM.1txwlt7IUemGJ.MUhPe3wp2kCRrWtuY/wJ9gQ9D.GkhuO'); -- password = admin
